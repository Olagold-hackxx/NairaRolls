...
import { Building2, Shield, Zap, Users, CheckCircle, ArrowRight, Star, Globe, Lock, TrendingUp, FileText, Coins, Network, Eye, Clock, Award, Play } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: 'Multi-Party Computation ensures no single point of failure. Your funds are secured with distributed key shares across multiple signers.',
    ...
    },
    {
      ...
      description: 'Define custom approval workflows with role-based access. Set thresholds like 2-of-3 or 3-of-5 for maximum security.',
      highlight: 'Customizable Workflows'
    },
    {
      icon: Zap,
      title: 'Bulk Payments',
      description: 'Process hundreds of payments in a single transaction. Save time and reduce costs with batch processing capabilities.',
      highlight: 'Efficient Processing'
    },
    {
      icon: Eye,
      title: 'Complete Transparency',
      description: 'Every transaction is recorded on-chain with full audit trails. Export compliance reports with one click.',
  ...
  const testimonials = [
    {
      ...
      content: 'NairaRolls transformed our payroll process. What used to take 3 days now happens in minutes, with complete security and transparency.',
      rating: 5
    },
    {
      name: 'Michael Adebayo',
      role: 'Operations Director, Hope Foundation',
      content: 'The multi-signer approval system gives us the security we need for our beneficiary payments. The audit trail is invaluable.',
      rating: 5
    },
    {
      name: 'Fatima Al-Hassan',
      role: 'HR Manager, Digital Solutions Ltd',
      content: 'Finally, a payroll system that understands the Nigerian market. cNGN integration makes compliance seamless.',
      rating: 5
    }
  ]
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Badge className="ml-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white border-0">Enterprise</Badge>
            </div>
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="#security" className="text-sm font-medium text-slate-300 hover:text-primary transition-colors">Security</Link>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-6 bg-gradient-to-r from-slate-700 to-slate-800 text-white border-0">
              🚀 Now supporting cNGN on Base, Polygon & BNB Chain
            </Badge>
            ...
            <p className="text-xl text-slate-700 dark:text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Secure, compliant, and transparent payroll management using MPC wallet technology 
              and cNGN stablecoin. Process bulk payments with multi-signer approvals in seconds, not days.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Link href="#demo">
                <Button size="lg" className="text-lg px-8 py-6 bg-slate-700 hover:bg-slate-600 text-white border-0 shadow-lg hover:shadow-xl transition-all">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
              {stats.map((stat, index) => (
                <div key={index} className="text-center bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-white/30 shadow-sm">
      ...
      <section id="features" className="py-20 bg-white dark:bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4 border-slate-300 text-slate-600 dark:border-slate-600 dark:text-slate-400">Core Features</Badge>
              ...
              <div className="group">
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">{features[2].description}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {features.slice(3).map((feature, index) => (
                <div key={index} className="group">
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 h-full">
                    ...
                    <Badge variant="secondary" className="mb-3 text-xs bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300">
                      {feature.highlight}
                    </Badge>
      ...
      <section id="solutions" className="py-20 bg-white dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4 border-slate-300 text-slate-600 dark:border-slate-600 dark:text-slate-400">Solutions</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900 dark:text-white">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (
              <Card key={index} className="p-8 hover:shadow-lg transition-shadow  dark:bg-gradient-to-br dark:from-gray-950 dark:via-slate-900 dark:to-gray-950 border-slate-200 dark:border-slate-700">
      ...
      <section id="security" className="py-20 bg-slate-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4 border-slate-300 text-slate-600 dark:border-slate-600 dark:text-slate-400">Security First</Badge>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900 dark:text-white">
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary dark:text-black">
                Contact Sales
              </Button>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <div className="flex gap-4">
                <Badge variant="outline" className="border-gray-600 text-gray-400">SOC 2 Compliant</Badge>
                <Badge variant="outline" className="border-gray-600 text-gray-400">ISO 27001</Badge>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              ...
              <Badge variant="outline" className="border-gray-600 text-gray-400">cNGN</Badge>
              <Badge variant="outline" className="border-gray-600 text-gray-400">Base</Badge>
              <Badge variant="outline" className="border-gray-600 text-gray-400">Polygon</Badge>
            </div>
          </div>
        </div>
      </footer>
